    ...
    return this.client({
      '/player/broadcast.js': function(){
        ...
        SocialCalc.ScheduleSheetCommands = function(sheet, cmdstr, saveundo, isRemote){
          ...
          // since 'set sheet defaulttextvalueformat' is not request by user
          // we do not want to push it into undo stack
          // also, the peers' action should not be saved in the undostack
          if(/^set sheet defaulttextvalueformat/.test(cmdstr) || isRemote) {
            saveundo = false;
          }
