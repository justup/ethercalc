    ...
    return this.client({
      '/player/main.js': function(){
        ...
        doPlay = function(){
          ...
          if (x$ != null) {
            x$.on('reconnect_error', function(){
              ...
              return showError('服務連線中斷，嘗試重新連線....');
            });
          }
          if (x$ != null) {
            x$.on('connect_failed', function(){
              return showError('重新連線失敗');
            });
          }
          emit = function(data){
            if (typeof data === 'object') {
              data.access_token = getCookie('access_token');
              data.password = getCookie(SocialCalc._room + '-password');
            }
            return this$.emit({
              data: data
            });
          ...
          return this$.on({
            data: function(){
              ...
              case 'ecell':
                ...
                SocialCalc.RenderCellPeerBorder(editor, this.data.ecell, this.data.seqid, this.data.displayName);
                FoxDocsAPI.firePeerLoginEvent(this.data.seqid, this.data.displayName, this.data.avatarUrl);
        ...
        onLoad = function(ssInstance){
          ...
          if (typeof ss.ExecuteCommand == 'function') {
            ss.ExecuteCommand('set sheet defaulttextvalueformat text-plain');
          }
